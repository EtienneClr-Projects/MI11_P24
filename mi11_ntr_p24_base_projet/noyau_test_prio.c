...
///////////////////////////////////////////
// #define test_full_periodic	
#define test_full_aperiodic
...
int main()
{
	...
	tab_tache_aperiodic[id].params = (void *) chaine;
//	for (int j = 0; j < 25; j++)
//	{
//		tab_tache_aperiodic[id].params[j] = (void *)chaine[j];
//	}
	...
	tab_tache_aperiodic[id].params = (void *) chaine2;
	...
	tab_tache_aperiodic[id].params = (void *) chaine3;
	//	for (int j = 0; j < 25; j++)
	//	{
	//		tab_tache_aperiodic[id].params[j] = (void *)chaine[j];
	//	}
	...
	while (1)
	{
		...
		while (tache_get_flag_tick(id_tache) != 0)
		{
			...
			if (id_tache == ID_P_CONTROLER_OUTILS)
			{
				...
				{
					// ACHETER DES OUTILS
					if (fifo_ajoute(&fifo_tache_aperiodic, 0) == 0)
					{
